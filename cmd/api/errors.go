...
// sends a 401 Unauthorized Response (invalid or authentication missing token)
func (app *application) invalidAuthenticationTokenResponse(w http.ResponseWriter, r *http.Request) {
	// remind the client to use a Bearer token
...
// sends a 401 Unauthorized Response (Aunthentication Required)
func (app *application) authenticationRequiredResponse(w http.ResponseWriter, r *http.Request) {
	message := "you must be authenticated to access this resource"
	app.errorResponse(w, r, http.StatusUnauthorized, message)
}

// sends a 403 Forbidden Response (Inactive account)
func (app *application) inactiveAccountResponse(w http.ResponseWriter, r *http.Request) {
	message := "your user account must be activated to access this resource"
	app.errorResponse(w, r, http.StatusForbidden, message)
}

// sends a 403 Forbidden Response (Not permitted)
